...
export const LogoConfiguration: React.FC<LogoConfigurationProps> = ({
  ...
  const logoEntries: LogoEntry[] = [
    {
      ...
      isCustomImage: Boolean(config.officialLogos?.find(l => l.id === 'logo-da')?.url && config.officialLogos.find(l => l.id === 'logo-da')?.url !== '/icon.jpg'),
    },
    {
      key: 'logo-mun',
      ...
      isCustomImage: Boolean(config.officialLogos?.find(l => l.id === 'logo-mun')?.url && config.officialLogos.find(l => l.id === 'logo-mun')?.url !== '/icon.jpg'),
    },
    {
      key: 'logo-slsu',
      ...
      isCustomImage: Boolean(config.officialLogos?.find(l => l.id === 'logo-slsu')?.url && config.officialLogos.find(l => l.id === 'logo-slsu')?.url !== '/icon.jpg'),
    },
    {
      key: 'logo-ext',
      ...
      isCustomImage: Boolean(config.officialLogos?.find(l => l.id === 'logo-ext')?.url && config.officialLogos.find(l => l.id === 'logo-ext')?.url !== '/icon.jpg'),
    },
    {
      key: 'logo-system',
      ...
      currentUrl: config.systemLogoUrl || config.faviconUrl || '/icon.jpg',
      ...
      isCustomImage: Boolean(config.systemLogoUrl && config.systemLogoUrl !== '/icon.jpg'),
    },
    {
      key: 'logo-header',
      ...
      currentUrl: config.headerLogoUrl || config.systemLogoUrl || '/icon.jpg',
      placement: 'header_left',
      defaultSizePx: 40,
      ...
      isCustomImage: Boolean(config.headerLogoUrl && config.headerLogoUrl !== '/icon.jpg'),
    },
    {
      key: 'logo-login',
    ...
    ...(config.officialLogos || [])
      ...
      .map((l, idx) => ({
        ...
        isCustomImage: Boolean(l.url && l.url !== '/icon.jpg'),
      })),
  ];
  ...
  const handleSaveLogoChanges = () => {
    ...
    if (editingLogoKey === 'logo-system') {
      draft.systemLogoUrl = candidateUrl || '/icon.jpg';
      draft.faviconUrl = candidateUrl || '/icon.jpg';
      draft.headerLogoWidth = editSizePx;
    } else if (editingLogoKey === 'logo-header') {
      draft.headerLogoUrl = candidateUrl || '/icon.jpg';
      draft.headerLogoWidth = editSizePx;
    } else if (editingLogoKey === 'logo-login') {
      draft.systemLogoUrl = candidateUrl || draft.systemLogoUrl || '/icon.jpg';
    } else {
  ...
  const handleResetSingleLogo = (key: string) => {
    ...
    if (key === 'logo-system' || key === 'logo-header') {
      draft.systemLogoUrl = '/icon.jpg';
      draft.headerLogoUrl = '/icon.jpg';
      draft.faviconUrl = '/icon.jpg';
    } else {
  ...
  const handleCreatePartnerLogo = () => {
    ...
    const newLogo: OfficialLogoItem = {
      ...
      url: newPartnerUrl.trim() || '/icon.jpg',
      category: 'partner',
              ...
              <div className="space-y-3">
                ...
                >
                  {logo.currentUrl && logo.currentUrl.trim() !== '' ? (
                    ...
                    <img src="/icon.jpg" alt="System Logo" className="w-16 h-16 object-contain" />
                  )}
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-32 rounded-2xl bg-stone-100 border border-stone-200 flex items-center justify-center p-3 overflow-hidden">
                  {activeEditingEntry.currentUrl && activeEditingEntry.currentUrl.trim() !== '' ? (
                    ...
                    <img src="/icon.jpg" alt="Default" className="w-16 h-16 object-contain" />
                  )}
                </div>
